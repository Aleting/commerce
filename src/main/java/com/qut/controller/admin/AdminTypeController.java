...
import com.qut.service.admin.AdminTypeService;
...
public class AdminTypeController extends BaseController {
	...
	public String deleteType(@PathVariable("id") String id, Model model) {
		System.out.print("zhengzaishanchu "+id);
		return adminTypeService.deleteType(Integer.parseInt(id), model);
	}
