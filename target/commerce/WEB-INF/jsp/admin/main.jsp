...
<body>
		...
		<ul>
			<li><a>商品管理</a>
				<ul>
					...
					<li><a href="adminGoods/selectGood?act=deleteSelect" target="center">删除商品</a></li>
					<li><a href="adminGoods/selectGood?act=updateSelect" target="center">修改商品</a></li>
					<li><a href="adminGoods/selectGood?" target="center">查询商品</a></li>
				</ul>
			</li>
			<li><a>类型管理</a>
				<ul>
	...
	<div id="content">
		<iframe src="adminGoods/selectGood"  name="center" frameborder="0"></iframe>
	</div>
	<div id="footer"><p> 备案号:鲁ICP备18015898号-2</p></div>
</body>
</html>
